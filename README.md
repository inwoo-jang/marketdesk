...
- **산업**: 표준 23개 세트(반도체·AI·IT·소프트웨어·자동차·석유화학·환경·기후·금융 등). 업로드 문서의 산업을 **AI 가 자동 매칭**(사용자 확인·수정 가능).
...
- **기본 공개 콘텐츠**: 업로드 없이도 보이는 산업별 콘텐츠 — 공개·허용 소스만(정책브리핑 korea.kr 등, KIET/KOTRA/KIEP/공공기관). 증권사 크롤링은 금지. 저작권 안전하게 **원문 재호스팅 없이 제목+우리 요약+출처 링크**만 저장, 산업 무관은 스킵(핵심만). 유저별 **숨김/다시 공개·즐겨찾기(책갈피)** 제공.
